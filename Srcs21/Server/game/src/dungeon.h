...
class CDungeon
{
	...
	void	JoinDungeonParty(LPPARTY pParty);

	void	QuitDungeonParty(LPPARTY pParty);
	...
	bool	IsDungeonTeam() const { return isDungeonTeam; }
	bool	SetDungeonTeam() { isDungeonTeam = true; }
