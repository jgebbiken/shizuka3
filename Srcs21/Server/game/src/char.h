...
//		bool			IsPet() const		{ return m_bCharType == CHAR_TYPE_PET; }
	...
	public:
		...
		void			SetBrowser(LPBROWSER pkBrowser);
		LPBROWSER		GetBrowser() const	{ return m_pkBrowser; }
...
//		AttackLog			m_kAttackLog;
	...
	public:
		...
		LPEVENT				m_pkDungeonBrowserEvent;
	...
	private:
        bool is_in_duell;
	public:
		void SetDuell(bool x){is_in_duell = x;}
		bool GetDuell(){ return is_in_duell;}
};
