...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_BROWSER_ADD, sizeof(TPacketCGBrowserAdd), "DungeonBrowserAdd", true);
	Set(HEADER_CG_BROWSER_REMOVE, sizeof(TPacketCGBrowserAdd), "DungeonBrowserRemove", true);
	Set(HEADER_CG_BROWSER_CREATE, sizeof(TPacketCGBrowserCreate), "DungeonBrowserCreate", true);
	Set(HEADER_CG_BROWSER_DESTROY, sizeof(TPacketCGBrowserDestroy), "DungeonBrowserDestroy", true);
